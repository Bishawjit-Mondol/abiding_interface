...
if ($_POST[$sc . 'submit']) {
	...
	if ($due >= $paying) {
		...
		$nt = $gt - $discount;
		$due = $nt - $paying;
		if ($_POST[$sc . 'submit'] == "Save as Order") {
			$status = 0;
		} elseif ($due > 0) {
			$status = 2;
		} elseif ($due == 0) {
				...
				<form method="POST">
					<table class="formaligner" align="center">
						...
						<tr>
							...
							<td class='r'>
								<?php if ($_POST['discount']) echo sprintf("%.2f", $_POST['discount']);
								else echo "0"; ?>
						...
						<tr>
							...
							<td class='r'>
								<?php if ($gt) echo sprintf("%.2f", ($gt - $_POST['discount']));
								else echo "0";
								$due = $gt - $_POST['discount'];  ?>
						...
						<tr>
							...
							<td class='r'>
								<?php if ($_POST['paying']) echo sprintf("%.2f", $_POST['paying']);
								else echo "0"; ?>
						...
						<tr>
							...
							<td class='r'>
								<?php if ($_POST['paying'] && $gt) echo sprintf("%.2f", ($gt - $_POST['discount'] - $_POST['paying']));
								else echo "0"; ?>
								<input type="hidden" name="paying" value='<?= $_POST['paying'] ?>' />
							</td>
						</tr>
						<tr>
							<th colspan="4">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="submit" name="<?php echo $sc; ?>submit" value="Save as Order" onClick="showloading();" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="submit" name="<?php echo $sc; ?>submit" value="Save as Delivered" onClick="showloading();" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table class="formaligner" align="center">
						<tr>
							<td colspan='3' style='' vertical-align:top;">
								Customer Details
								<br />
								<textarea name="customer" rows="2" cols="70"><?php echo stripslashes($_POST['customer']); ?></textarea>
							</td>
						</tr>
						<?php
						echo "
						...
						for ($i = 0; $i < 6; $i++) {
							...
							echo "
										...
										<th>
											<input type='number'  name='quantity" . $i . "' value='" . $_POST['quantity' . $i] . "'>
										</th>
										<th>
											<input type='number'  name='rate" . $i . "' value='" . $_POST['rate' . $i] . "'>
										</th>
									</tr>
								";
						}
