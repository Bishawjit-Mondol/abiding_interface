                ...
                <form class="bs-example form-horizontal" >
                    <fieldset>
							...
							<div class = 'col-lg-12'>
									<div class="input-group margin-bottom-sm">             
				                       <span class="add-on input-group-addon input-group-addon-2x"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i> 
				                       	<?=$label_1;?> </span><input type="text" id = 'form_0000_d1'  name="d1"  class="form-control date" />       
				                       	<script>
				                       		$("#form_0000_d1").val($("#entryday").val());
					   ...
					   <div class="form-group" hidden>
							<div class = 'col-lg-12'>
								<div class="input-group margin-bottom-sm">
								  ...
								  <input class="form-control" name = 'v4' value='0' type="text" /> 
					   ...
					   <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12">
                            <button type="button" class="btn btn-primary btn-submit-form btn-submit" save-type = "1" ><i class="fa fa-thumbs-up"></i><?php echo $label_10 ;?></button>
						  </div>
                        </div>
