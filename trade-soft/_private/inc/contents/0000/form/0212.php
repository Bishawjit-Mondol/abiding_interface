	...
	<tbody>
		<tr>
			<td>
				<table height="140px">
					<tr>
						<td width="352px"> <?php echo($lang == 1 ? "বিক্রয় তারিখ" : "Purchase Date");?> :  <?php echo ( $det[0][9] != null && $det[0][9] != '0000-00-00' ? dateconvert($det[0][1]) : "Not Yet" ); ?></td>
					</tr>					
					<!--
					<tr>
			...
			<td>
				<table height="140px">
					<tr>
						<td width="354px" valign="top"> <?php echo($lang == 1 ? "বিক্রেতার নাম ও ঠিকানা   " : "Supplier Name & Address  ");?> :   <?php echo $det[0][13]."<br/>".$det[0][14];?></td>
					</tr>
...
<div class = 'chalan_print_try <? if(!$fpp){ echo 'pagebreak'; } ?>' >
	<table class='roundangled20 <? if(!$fpp){ echo 'pagebreak'; } ?> '  >
		...
		<tr><td align = 'center' colspan = '2' class='banner'>Purchase : AG<?=$det[0][0];?></td></tr>
		<tr class='topinfo'>
			  ...
			  <td width = '40%'>
				  ...
				  <table>
					...
					-->
					<tr>
						<td width="352px"> <?php echo($lang == 1 ? "ক্রয় অাই, ডি" : " Purchase ID");?> :  <?php echo $det[0][0];?></td>
					</tr>
				  </table>
		      </td>
			  <td width = '60%' >
				  <table>
					   ...
					   <tr>
							<td> <?php echo($lang == 1 ?  "গ্রহনকারী " : "Receiver Officer");?> :    <?php echo $det[0][11];?>, <?php echo($lang == 1 ? "মোবাইল" : "Mobile");?>  :  <?php  echo $det[0][12]; ?> </td>
					   </tr>
