	...
	<tr>
	   ...
	   <td width="47%">
		<table class ='table ' width="97%" >
			...
			<tr>
				<td><i class = 'fa fa-truck'></i> <?php echo ($lang == 1 ? "যাতায়াত খরচ" : "Transport");?></td><td>+</td><td class = 'sales-f-trp set-html-zero'><?php  if($det[0][25]>0){ echo $inp->cb($det[0][25]);}else{ echo $inp->cb(0) ;}?></td>
			</tr>
			<tr class = 'row-red' >
				<td><?php echo ($lang == 1 ? "মোট পাওনা" : "Total Receivable");?></td><td>: </td><td><label class = 'sales-f-ar set-html-zero'> <?php  echo $inp->cb($tot);?></label> <?php echo ($lang == 1 ? " টাকা মাত্র " : "Taka Only");?> </td>
			</tr>
	        </table>
	   </td>
	</tr>
