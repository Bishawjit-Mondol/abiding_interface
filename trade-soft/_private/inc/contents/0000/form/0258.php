<?
	$label_1 =  ($lang == 1 ? " গুদামের নাম" : "Godown Name"); 
                    ...
                    <fieldset>
                       <legend><?=$page_title;?></legend>
                        ...
                        <div class="form-group">
							...
							<button type="button" class="btn btn-primary btn-submit-form btn-submit" save-type = "1" ><i class="fa fa-thumbs-up"></i> <?=$label_3;?></button>
