<?
	...
	$label_8 =  ($lang == 1 ? "পূর্বের পাওনা " : "Opening Balance");
	...
	$details = $qur->custom_select_query("SELECT idcompany, ___find_company_name(idcompany) COMPANY, SUM(s_amount), SUM(sr_amount), SUM(s_amount)-SUM(sr_amount) as net_sale, SUM(tran),___find_previous_sales_balance(idcompany, '0000-01-01')
FROM (
