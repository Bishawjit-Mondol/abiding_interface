...
?>
                ...
                <form class="bs-example form-horizontal link">
                    <fieldset>
                        <legend><?php echo ($lang? "নতুন":"New ");  echo req('cat_name');?> <?php echo ($lang? "বিক্রয় ফেরৎ" : "Sales Return"); ?></legend>
	               ...
	               <? } ?>         
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class="fa fa-fw fa-user"></i> <? echo ($lang? ' মন্তব্য' :' Prepared By');?></span>
	                        ...
	                        <div class="form-group">
								...
								<div class="col-lg-4">
										<table class ='table pull-right'>
												...
												<tr class = 'row-red' >
														<td ><?php echo ($lang == 1 ? " দেনা " : "Amount Payable");?></td><td>: </td><td><label class = 'sales-f-ar set-html-zero'><?php echo $inp->cb(0.00);?></label><?php echo ($lang == 1 ? " টাকা মাত্র " : "Taka Only");?> </td>
												</tr>
