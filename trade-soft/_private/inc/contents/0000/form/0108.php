...
?>
                ...
                <form class="bs-example form-horizontal link">
                    <fieldset>
                        <legend>New <?php echo req('cat_name');?> Purchase Return</legend>
	                        <div class="form-group">
								...
								<div class = 'col-lg-3'>
									<div class="input-group margin-bottom-sm">
									  ...
									  <select name = 'v2' class = 'form-control client supplier integer'>
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm"> 
									  <span class="input-group-addon"><? echo ($lang? ' মূল্যহৃাস' :' Discount');?></span>
						               <input type = 'text' name = 'sales_dis_tot'  value = '0.00'   class = 'sales_discount form-control set-zero'  disabled />  									
									</div>                   
	                            </div>
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm"> 
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm"> 
									  <span class="input-group-addon"><? echo ($lang? ' মূল্যহৃাস' :' Delivery Address');?></span>
						               <input type = 'text' name = 'sales_dlv'  value = ''  class = 'sales_discount form-control' />  									
									</div>                   
								...
								<div class="col-lg-4">
										<table class ='table pull-right'>
												<tr>
														<td>Subtotal</td><td></td><td class = 'sales-f-subt set-html-zero'>0.00</td>
												</tr>
												<tr>
														<td>Discount <span class = 'sales-f-disr'>0</span> %</td><td>-</td><td class = 'sales-f-dis set-html-zero'>0.00</td>
												</tr>
												<tr>
														<td><i class = 'fa fa-truck'></i> Transport</td><td>+</td><td class = 'sales-f-trp set-html-zero'>0.00</td>
												</tr>
												<tr class = 'row-red' >
														<td >Ammount Recivable</td><td>: </td><td><label class = 'sales-f-ar set-html-zero'>0.00</label> Taka Only</td>
												</tr>
