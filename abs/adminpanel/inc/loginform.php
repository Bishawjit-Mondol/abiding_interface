		...
		elseif ($logerror == 4)
			$errormessage = "<h2 class='red'>Your User Permission is Suspended</h2>";
		?>
				...
				<div id="loginform">
					<form method="POST">
						...
						<table align="center" border="0px">
							...
							<tr>
								<td colspan="2" class="centerized"><input type="submit" name="login" value="Login" /></td>
							</tr>
						</table>
					</form>
				</div>
