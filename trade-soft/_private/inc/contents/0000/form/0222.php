<?
	...
	$label_3 =  ($lang == 1 ? "যে ব্যক্তির সাথে লেনদেন" : "Transaction With");
						...
						<div class="form-group">
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<?
											$det = $qur->custom_select_query("SELECT idincentive_reciver , incentive_reciver_name FROM incenvice_reciver  ORDER BY incentive_reciver_name;");
											
											$inp->d2_array_drop_down('v2', $det , req('v2'), null ,'numeric integer form-control' ); 
									?>
								</div>                   
							</div>     
						</div>
							...
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<select name="v3" class="form-control integer">
											<option></option>
											<?php $det = $qur->custom_select_query("SELECT idtransaction_head, transaction_head_name FROM transaction_head WHERE  idtransaction_head_type = 5 ORDER BY transaction_head_name;"); ?>
