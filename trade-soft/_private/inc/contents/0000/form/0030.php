...
?>
                ...
                <form class="bs-example form-horizontal link">
                    <fieldset>
                 <legend><?php echo ($lang == 1 ? " নতুন " : "New"); echo req('cat_name');?><?php echo ($lang == 1 ? " ক্রয় " : "  Purchase");?></legend>
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class ='fa  fa-comments-o'></i> <? echo ($lang? ' মন্তব্য' :' Remarks');?></span>
						               <input type = 'text' name = 'purchase_comments'   class = 'purchase_comments form-control' />  									
									</div>                   
	                            </div>
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class="fa fa-fw fa-user"></i> <? echo ($lang? ' ক্রেতা ' :' purchase By');?></span>
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm"> 
									  <span class="input-group-addon"> <i class = 'fa fa-truck'></i> <? echo ($lang? ' যাতায়াতে খরচ ' :' Transport');?></span>
						               ...
						               <input type = 'hidden' name = 'cat_id' class="optional" value = '<? echo $_REQUEST['cat_id'];?>' />
									</div>                   
	                            </div>
	                        ...
	                        <div class="form-group">
								...
								<div class="col-lg-4">
										<table class ='table pull-right'>
												<tr>
														<td><?php echo ($lang == 1 ? "মোট " : "SubTotal");?></td><td></td><td class = 'purchase-f-subt set-html-zero'><?php echo $inp->cb(0.00);?></td>
												</tr>
												<tr>
														<td><?php echo ($lang == 1 ? "মূল্য হ্রাস" : "Discount");?><span class = 'purchase-f-disr'><?php echo $inp->cb(0);?></span> %</td><td>-</td><td class = 'purchase-f-dis set-html-zero'><?php echo $inp->cb(0.00);?></td>
												</tr>
												<tr>
														<td><i class = 'fa fa-truck'></i><?php echo ($lang == 1 ? "যাতায়াতে খরচ" : "Transport");?></td><td>+</td><td class = 'purchase-f-trp set-html-zero'><?php echo $inp->cb(0.00);?></td>
												</tr>
												<tr class = 'row-red' >
														<td ><?php echo ($lang == 1 ? " সর্ব মোট " : " Amount Payable");?></td><td>: </td><td><label class = 'purchase-f-ar set-html-zero'><?php echo $inp->cb(0.00);?></label><?php echo ($lang == 1 ? " টাকা মাত্র " : "Taka Only");?> </td>
												</tr>
