<?
	$label_1 =  ($lang == 1 ? "পদবীর নাম" : "Post Name"); 
	$label_2 =  ($lang == 1 ? "বিভাগ" : "Division");
					   ...
					   <div class="form-group">
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<? $inp->d2_array_drop_down("v2",$qur->custom_select_query("SELECT * FROM division ORDER BY division_priority DESC;"), req('v2'),'' , 'form-control'); ?>
								</div>                   
							</div>     
						</div>
