...
<form method='POST' class="embossed" action="index.php?page=<?php echo $page; ?>&&data_id=<?php echo $data_id; ?>&&order=1">
	...
	<table class="formalign" align="center" width="700px">
		<tr>
			<td>Name :</td>
			<td><input type="text" name="name2" value="<?php echo htmlentities(stripslashes($_POST['name2'])); ?>" /><big class='red'>*</big></td>
		</tr>
		<tr>
			<td>Address :</td>
			<td><input type="text" name="address" value="<?php echo htmlentities(stripslashes($_POST['company2'])); ?>" /></td>
		</tr>
		<tr>
			<td>E-mail :</td>
			<td><input type="text" name="email2" value="<?php echo htmlentities(stripslashes($_POST['email2'])); ?>" /></td>
		</tr>
		<tr>
			<td>Country :</td>
			<td>
		...
		<tr>
			<td>Phone :</td>
			<td><input type="text" name="phone" value="<?php echo htmlentities(stripslashes($_POST['phone'])); ?>" /><big class='red'>*</big></td>
		</tr>
		<tr>
			<td>Booking Description :</td>
			<td><textarea name="description" rows="5" cols="50"><?php echo htmlentities(stripslashes($_POST['description'])); ?></textarea></td>
		</tr>
		<tr>
			<td colspan="2">
				<center><input type="submit" name="order" value="Order"></center>
			</td>
		</tr>
	</table>
</form>