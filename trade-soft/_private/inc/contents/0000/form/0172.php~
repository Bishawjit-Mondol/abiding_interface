...
?>
                ...
                <form class="bs-example form-horizontal link">
                    <fieldset>
                        <legend><?php echo ($lang ?  "চীন থেকে ক্রয়" : "Purchase From China"); ?> </legend>
	                            ...
	                            <div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><? echo ($lang? ' ডলার রেট' :' Dollar Rate');?></span>
						               <input type = 'text' name = 'purchase_dollar_rate'   class = 'purchase_dollar_rate form-control' value = '80' />
									</div>                   
	                            </div>
								<div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class ='fa  fa-comments-o'></i> <? echo ($lang? ' মন্তব্য' :' Remarks');?></span>
						               <input type = 'text' name = 'purchase_comments'   class = 'optional purchase_comments form-control' value = 'none' />  									
									</div>                   
	                            </div>
	                            <div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class="fa fa-fw fa-user"></i> <? echo ($lang? ' ক্রয়কারী' :' Purchase By');?></span>
						               <select name = 'purchase_by'   class = 'purchase_by form-control' > 
												...
												<?php foreach($det as $d){ ?>
													<option value = "<?php echo $d[0];?>" <?php if($d[0]==4){ echo "selected"; } ?> ><?php echo $d[1];?></option>
												<?php } ?>	
						               </select>
									</div>                   
	                            </div>
	                        ...
	                        <div class="form-group hidden">
							 ...
							 <div class="form-group">
	                            ...
	                            <div  class="col-lg-4">
									...
									<button type="button" class="hidden btn btn-primary btn-submit-form btn-submit" save-type = "1" ><i class="fa fa-thumbs-up"></i> <? echo ($lang? ' নিশ্চিত করুন' :' Confirm');?></button>
