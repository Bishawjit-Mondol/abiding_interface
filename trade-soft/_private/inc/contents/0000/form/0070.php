...
?>
                ...
                <form class="bs-example form-horizontal link">
                    <fieldset>
                        <legend><?php echo ($lang? "নতুন  ":"New ");  echo req('cat_name'); echo ($lang? " বিক্রয় ফেরৎ" : " Sales Return"); ?> </legend>
	                        <div class="form-group">
								...
								<div class = 'col-lg-4'>
									<div class="input-group margin-bottom-sm">
									  ...
									  <select name = 'v3' class = 'form-control p-place showroom godown integer' id = 'form-<?php echo $_REQUEST['sub'];?>-godwon'>
										<option></option>
									  </select>
									</div>                   
								</div>
	               ...
	               <? } ?>         
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class="fa fa-fw fa-user"></i> <? echo ($lang? ' প্রস্ততেকারী' :' Prepared By');?></span>
	                        ...
	                        <div class="form-group">
								...
								<div class="col-lg-8">
										<table class ='table pull-right'>
												<tr>
														<td><?php echo ($lang == 1 ? "পাইপের মোট মূল্য " : "Pipe Price ");?></td><td></td><td class = 'purchase-f-subtp set-html-zero' style="text-align:right" ><?php echo $inp->cb(0.00);?></td>
												</tr>
												<tr>
														<td><?php echo ($lang == 1 ? "ফিটিংসে মোট মূল্য " : "Fittings Price ");?></td><td></td><td class = 'purchase-f-subf set-html-zero' style="text-align:right" ><?php echo $inp->cb(0.00);?></td>
												</tr>
