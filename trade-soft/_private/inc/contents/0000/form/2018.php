                ...
                <form class="bs-example form-horizontal link">
                    <fieldset>
                        <legend><?php echo ($lang? "নতুন":"New ");  echo req('cat_name'); echo ($lang? " বিক্রয়":" Sales "); ?> </legend>
								...
								<div class = 'col-lg-3'>
									<div class="input-group margin-bottom-sm">
				                       <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i> 
				                       	<?php echo $label_1;?> </span><input type="text"  name="d1"  class="form-control date" />       
		          		           </div>									
								</div>
								<div class = 'col-lg-3'>
									<div class="input-group margin-bottom-sm">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div  class="col-lg-2">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"> <strong> <?php echo ($lang? ' বার কোড নং ' :' Bar code Sl.');?> </strong> </span>
									</div>                   
	                            </div>
	                        ...
	                        <div class="form-group sales-data-form row-data-form">
	                            ...
	                            <div  class="col-lg-2">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon input-label"><i class = 'fa fa-barcode'></i></span>
									  
										<input type = 'text' class = 'form-control barcode-input sales-data'   name = 'code_<?php echo $i; ?>' />								
									</div>                   
	                            </div>
	                            <div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon input-label"><i class = 'glyphicon glyphicon-shopping-cart'></i></span>
						               ...
						               <select class = 'form-control product product-show-details sales-data' did = "<?php echo req('cat_id'); ?>"  name = 'sales_product_0' placeholder = "Prdouct" readonly  >
										</select> 
									</div>                   
	                            </div>
					...
					<? for($i=1; $i<10; $i++){ ?>
	                        <div class="form-group  row-data-form sales-data-form hidden">
	                            ...
	                            <div  class="col-lg-2">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon input-label"><i class = 'fa fa-barcode'></i></span>
										<input type = 'text' class = 'form-control barcode-input'   name = 'code_<?php echo $i; ?>' />		
									</div>                   
	                            </div>
	                            <div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
	               ...
	               <? } ?>         
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div  class="col-lg-4">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon"><i class="fa fa-fw fa-user"></i> <?php echo ($lang? 'বিক্রয়কারী' : 'Sales By');?></span>
	                        ...
	                        <div class="form-group">
							 ...
							 <div class="form-group">
	                            ...
	                            <div  class="col-lg-4">
									...
									<button type="button" class="btn btn-primary btn-submit-form btn-submit" save-type = "2" ><i class="fa fa-lightbulb-o"></i><?php echo($lang? ' প্রস্তাব করুন' : ' Propose'); ?></button>
								</div>
