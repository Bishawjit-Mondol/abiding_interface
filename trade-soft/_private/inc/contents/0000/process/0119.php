<?php 
	...
	$report = ($lang ?  "প্রস্তাবিত লেনদেন " : "Proposed Transaction");
		
	$d1 = req('d1');
	$d2 = req('d2');
	//$c1 = req('c1') > 0 ?  req('c1') : 0 ;
	$total = 0.00;
	$details = $qur->custom_select_query("CALL ___show_pro_cash_bank_statement( 0, 0, '".$d2."','".$d1."')");
	$n = count($details);
?>
			<?php include('rh.php'); ?>
			<div class="bs-example table-responsive ">
			  ...
			  <table class="table table-striped table-hover report-table">
					...
					<tr>
					  ...
					  <th width='200'><?php echo $label_6;?></th>
	...
	<?php for($i=0; $i<$n;$i++){ ?> 
					<tr>
					  ...
					  <td  class = 'action'>
							...
							<button type ='button' class='inactive page-loader box-entry link0100 btn btn-info confirm_trn_<?php echo $details[$i][0];?>' data =  "&id=<?php echo $details[$i][0]; ?>&ln=<?php echo $lang; ?>"  ><?php echo ($lang == 1 ? " সংশোধন করুন " : " Edit");?></button>
					 </td>
