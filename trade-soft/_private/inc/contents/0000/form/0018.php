						...
						<div class="form-group">
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<!--<select name="v2" class="form-control employee integer " did = "1">--> 
									<select name="v2" class="form-control employee integer " > 
							...
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<select name="v3" class="form-control integer">
											<option></option>
											<?php $det = $qur->custom_select_query("SELECT idtransaction_head, transaction_head_name FROM transaction_head WHERE  idtransaction_head_type = 1 ORDER BY transaction_head_name;"); ?>
