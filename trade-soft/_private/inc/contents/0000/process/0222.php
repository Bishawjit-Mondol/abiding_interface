<?
	...
	if($flag){  
    $query2[0] = 'transaction_incentive_reciver';
    $query2[1] = 'ii';
    $query2[2] = array('idtransaction','idincentive_reciver'); 
    ...
    if($flag){
		...
		*/
        ...
        $qur->con->rollback(); 
        $ret_msg = ($lang ?  " দু:খিত, ব্যর্থ হয়েছে ।" : " Failed to do." ).$ret_msg.''.get_insert_query($query3);
    }
    unset($query);    
