<?php
	function dbconnect()
	{
		mysql_connect("localhost","garageba_visitor","0VK2I~[3+X(9") || die(mysql_error());
		mysql_select_db("garageba_site") || die(mysql_error());
	...
	function get_price($text_data_id)
	{
		...
		{
			$price=$price.bfn($ar['price'],0)." Taka Only";
		...
		if($ar['note'])
		{
			$price=$price."<br/><small>".$ar['note']."</small>";
		}
		if($ar2['stock']>0)
		{
