<?
    ...
    $label_2 =  ($lang == 1 ? "বিক্রয় আই. ডি." : "Purchase return ID"); 
    $label_3 =  ($lang == 1 ? "তারিখ " : "Date"); 
    $label_4 =  ($lang == 1 ? "বিক্রেতা " : "Suppler");     
    $label_5 =  ($lang == 1 ? "শো-রুম " : "Showroom ");
    $label_6 =  ($lang == 1 ? "মূল্য" : "Ammount");
    $label_7 =  ($lang == 1 ? "পদক্ষেপ " : "Action");
    $report = ($lang ?  "ক্রয় ফেরতের রিপোর্ট" : "Purchase Return History");
	$d1 = req('d1');
	$d2 = req('d2');
	...
	$details = $qur->custom_select_query("CALL ___show_purchase_return_history( $c1, $c2 ,'".$d2."','".$d1."');");
	//echo "CALL ___show_purchase_return_history( $c1, $c2 ,'".$d2."','".$d1."');";
	$n = count($details);
?>
			<?php include('rh.php'); ?> 
	...
	<? for($i=0; $i<$n;$i++){ ?> 
					<tr>
					  ...
					  <td  class = 'action'>
							<button type ='button' class='btn btn-info confirm_sal inactive page-loader box-entry link0332 ' data="&id=<? echo $details[$i][0];?>" >Show </button>
					</td>
