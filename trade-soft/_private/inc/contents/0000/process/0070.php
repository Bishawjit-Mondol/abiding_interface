<?php
  ...
  if(req('submit_type')=='2'){
    ...
    if($flag){                
			...
			$queryax[3] = array($v1, post('purchase_discount_fitt') , post('purchase_comments') , 1 , $idstaff ?$idstaff: 0  , post('purchase_by') , $cat , post('purchase_trns') , post('v3') , post('purchase_discount_pipe'), req_date('d1'), req_date('d1') );
...
/*---------------------------------------------------------------------------------------*/
        ...
        $link[$li++]['type'] = 'inactive page-loader box-entry link0160 btn btn-info';
