						...
						<div class="form-group">
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<select name="v2" class="form-control   integer">
										<option></option>
										<?php $det = $qur->custom_select_query("SELECT idloan, CONCAT('LOAN ID : ',idloan, '   ( ',lender_name , ' ) ') FROM loan LEFT JOIN lender USING(idlender);");?>	
							...
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<select name="v3" class="form-control integer">
											<option></option>
											<?php $det = $qur->custom_select_query("SELECT idtransaction_head, transaction_head_name FROM transaction_head WHERE  idtransaction_head_type = 4 ORDER BY transaction_head_name;"); ?>
											<?php foreach($det as $d){ ?>
													<option value = '<?php echo $d[0];?>'><?php echo $d[1];?></option>
											<?php } ?>
									</select>
