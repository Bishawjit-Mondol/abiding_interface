				...
				<h4>Edit <?=$caption;?></h4>
					...
					<table class="formaligner" align="center">
						...
						<tr>
							...
							<td>
								<input type="checkbox" name="slides" value="slides" <? if(check_img($img,'slides')) echo "checked='1'";?>>Slides
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="units" value="units"<? if(check_img($img,'units')) echo "checked='1'";?>>Units
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="career" value="career"<? if(check_img($img,'career')) echo "checked='1'";?>>Career
								<br/><input type="checkbox" name="management" value="management"<? if(check_img($img,'management')) echo "checked='1'";?>>Management
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="contact" value="contact"<? if(check_img($img,'contact')) echo "checked='1'";?>>Contact
							</td>
						</tr>
						<tr>
							<td>
