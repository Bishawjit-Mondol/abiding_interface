	                            ...
	                            <div  class="col-lg-2">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon input-label"><i class = 'fa fa-barcode'></i></span>
										...
										<input type = 'text' class = 'form-control barcode-input-mpp sales-data-mpp'   name = 'code_<?php echo $i; ?>' />								
									</div>                   
	                            </div>
	                            <div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon input-label"><i class = 'glyphicon glyphicon-shopping-cart'></i></span>
						               ...
						               <select class = 'form-control product product-show-details sales-data-mpp' did = "<?php echo req('cat_id'); ?>"  name = 'sales_product_0' placeholder = "Prdouct" readonly  >
										</select> 
									</div>                   
	                            </div>
					...
					<? for($i=1; $i<10; $i++){ ?>
	                        <div class="form-group  row-data-form sales-data-form hidden">
	                            ...
	                            <div  class="col-lg-2">
									<div class="input-group margin-bottom-sm">
									  <span class="input-group-addon input-label"><i class = 'fa fa-barcode'></i></span>
										<input type = 'text' class = 'form-control barcode-input-mpp'   name = 'code_<?php echo $i; ?>' />		
									</div>                   
	                            </div>
	                            <div  class="col-lg-3">
									<div class="input-group margin-bottom-sm">
