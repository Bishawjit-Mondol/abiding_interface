					...
					if($_POST['pre_id']&&$_POST['pre_pass']&&$_POST['new_id_1']&&$_POST['new_id_2']){
					   ...
					   $real_pass=$_SESSION[pass];
						...
						elseif(($pre_id!=$real_id)||($pre_pass!=$real_pass)){
							...
							$q=mysql_query("UPDATE user SET pass='".md5($new_id_1)."'  WHERE enuser='".$real_id."' AND pass='".$real_pass."'");
							if(!$q){
								$say=3;
							}
							else{
				...
				<form method='POST'>
				    <table class="formaligner" align="center">
						...
						<tr>
							...
							<td>
								<input type='password' name='new_id_1'/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type='password' name='new_id_2'/>
							</td>
						</tr>
						<tr>
