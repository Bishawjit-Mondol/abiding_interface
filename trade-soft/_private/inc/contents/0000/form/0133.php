						...
						<div class="form-group">
							<div class = 'col-lg-5'>
								<div class="input-group margin-bottom-sm">
								  ...
								  <? 
										$qr = "SELECT idcompany, concat(company_name, ' (ID : ', idcompany , ')' ) FROM company WHERE company_type = 2 AND idcompany != 223 ORDER BY company_name;";
										if($usertype == 1){
											$qr = "SELECT idcompany, concat(company_name, ' (ID : ', idcompany , ')' ) FROM company WHERE company_type = 2";
										}
							...
							<div class = 'col-lg-5'>
								<div class="input-group margin-bottom-sm">
								  ...
								  <select name = 'c2' class = 'form-control showroom godown' />
