	...
	<tbody>
		<tr>
			...
			<td>
				<table height="140px">
					<tr>
						<td width="354px" valign="top"> <?php echo($lang == 1 ? "ক্রেতা এবং ঠিকানা" : "Client & Address");?> :   <?php echo $det[0][13]."<br/>".$det[0][14];?></td>
					</tr>
...
<?php $subtotal = 0;  $discount = $det[0][20] + $det[0][17] ; $transport = $det[0][19];  $i = 0; $tot = 0; foreach($det2 as $d){ ?>
		<tr>
