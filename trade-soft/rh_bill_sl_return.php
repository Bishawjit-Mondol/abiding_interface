<div class = 'cl-lg-12' class='report-head'>
		   <table align='center' width = '100%' class = 'report-head'>
			<tr>
				<td colspan = '2' width = '100%' ><h2 style = 'text-align:center'>Sales Return : AG<?php echo $id;?></h2></td>
			</tr>
			...
			<tr>
				<td width = '35%'>
					<table height="180px" width = '100%' border = '1px'>
						<tr>
							<td width="100%" > <?php echo($lang == 1 ? "বিক্রয় তারিখ" : "Sales Return Date");?> :  <?php echo dateconvert($det[0][1]);?></td>
						</tr>					
			...
			<td width = '65%' >
				<table height="180px" width = '100%' border = '1px'>
					<tr>
						<td width="100%" valign="top"> <?php echo($lang == 1 ? "ক্রেতা এবং ঠিকানা" : "Client & Address");?> :   <?php echo $det[0][13]."<br/>".$det[0][14];?></td>
					</tr>
					<tr>
