...
<form class="bs-example form-horizontal" >
    ...
    <legend><?php echo $page_title;?></legend>	
        ...
        <!--  -------------------------------------------------------------------------------------------------------------------- -->
        <!--  অনুবাদ 3  ,  Registartion Date শুরু হচ্ছে -->
        <!--  -------------------------------------------------------------------------------------------------------------------- --> 
        ...
        <!--  -------------------------------------------------------------------------------------------------------------------- -->
        <!--  অনুবাদ 3  ,  Registartion Date শেষ হচ্ছে -->
        <!--  -------------------------------------------------------------------------------------------------------------------- --> 
        ...
        <div class="form-group">
            <div class = 'col-lg-6'>
                <div class="input-group margin-bottom-sm">
                    ...
                    <input type="text" name = 'v3' value = '<?php echo req('v3'); ?>'   class="form-control  numeric"  />
                </div>
            </div>
        </div>
        ...
        <!--  -------------------------------------------------------------------------------------------------------------------- -->
        <!--  অনুবাদ 4  ,  Incentive Rate শেষ হচ্ছে -->
        <!--  -------------------------------------------------------------------------------------------------------------------- --> 

	    <!--  -------------------------------------------------------------------------------------------------------------------- -->
        <!--  অনুবাদ 8  ,  Educational Qualification শুরু হচ্ছে -->
        <!--  -------------------------------------------------------------------------------------------------------------------- --> 

        <!--  -------------------------------------------------------------------------------------------------------------------- -->
        <!--  অনুবাদ 7  ,  Date of Birth শুরু হচ্ছে -->
        <!--  -------------------------------------------------------------------------------------------------------------------- --> 
        ...
        <div class="form-group">
            <div class = 'col-lg-6'>
                <div class="input-group margin-bottom-sm">
                    ...
                    <input type="text" name = 'd5'  class="form-control positive numeric"  />
                </div>
            </div>
        </div>
