							...
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<select name="v2" class="form-control   integer">
											<option></option>
											<?php $det = $qur->custom_select_query("SELECT idpropiter, propiter_name FROM propiter;"); ?>
							...
							<div class = 'col-lg-6'>
								<div class="input-group margin-bottom-sm">
									...
									<select name="v3" class="form-control integer">
											<option></option>
											<?php $det = $qur->custom_select_query("SELECT idtransaction_head, transaction_head_name FROM transaction_head WHERE  idtransaction_head_type = 2 ORDER BY transaction_head_name;"); ?>
											<?php foreach($det as $d){ ?>
													<option value = '<?php echo $d[0];?>'><?php echo $d[1];?></option>
											<?php } ?>
									</select>
