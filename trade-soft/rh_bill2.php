			...
			<td>
				<table height="150px">
					<tr style="border-bottom:solid 1px #000">
						<td width="352px" v-align="top"><b><?php echo ($lang == 1 ? " বিল তারিখ " : "Bill Date");?></b><?php echo $det[0][22];?> </td>
					</tr>	
					<tr style="border-bottom:solid 1px #000">
						<td><b> <?php echo ($lang == 1 ? " বিক্রয় তারিখ " : "Sales Date");?></b> <?php echo dateconvert($det[0][6]);?></td>
					</tr>
					<tr style="border-bottom:solid 1px #000">
						<td><b><?php echo ($lang == 1 ? " দি . ও . তারিখ " : "D.O.Date");?></b> <?php echo dateconvert($det[0][2]);?></td>
					</tr>
					<tr>
