<?
	...
	if($flag){  
		...
		$ret_msg = $ret_msg."UPDATE company_details SET company_contactperson = '".$v7."', company_contactperson_phone = '".$v8."' , company_comission= ".$v4.", company_reg_date= '".$date."' WHERE idcompany = ".$v0;
	}
