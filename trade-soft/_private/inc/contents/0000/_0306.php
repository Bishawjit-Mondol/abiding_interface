		...
		<tr>
			...
			<td>
				<table height="140px">
					...
					<tr>
						<td> <?php echo($lang == 1 ? "বিক্রয় কর্মী" : "Sales Officer");?> :    <?php echo $det[0][11];?>, <?php echo($lang == 1 ? "মোবাইল" : "Mobile");?>  :  <?php  echo $det[0][15]; ?> </td>
					</tr>
...
<div class="form-group">
	<div class = 'col-lg-2'>
		<div class="input-group margin-bottom-sm">
		  <span class="input-group-addon input-group-addon-2x input-label print-bill-secial"><i class = 'fa fa-print'></i> </span>
		</div>                  
	</div>        
</div>
<br/>
...
<div class = 'chalan_print_try <? if(!$fpp){ echo 'pagebreak'; } ?>' >
	<table class='roundangled20'>
		...
		<tr><td align = 'center' colspan = '2' class='banner'>Delivery Bill : <?=$det[0][0];?></td></tr>
		<tr class='topinfo'>
			  ...
			  <td width = '40%'>
				  ...
				  <table>
					  ...
					  <tr>
						<td> <?php echo($lang == 1 ? "ডি, ও, অাই, ডি" : " D.O. ID");?> :  <?php echo $det[0][0];?></td>
					  </tr>
			  ...
			  <td width = '60%' >
				  <table>
  					   <tr>
					      <td> <?php echo($lang == 1 ? "ক্রেতা ও ঠিকানা   " : "Customer & Address  ");?> :   <?php echo $det[0][13]."<br/>".$det[0][14];?>
					      </td>
					  </tr>
...
?>
		<tr>
			...
			<td><?php echo $inp->cb(two_dec($arr[$i][4]*$arr[$i][3])); 
			...
			<td style = 'text-align:right'>
				<?php $tp = ($arr[$i][3]*$arr[$i][4])-(($arr[$i][3]*$arr[$i][4])/100)*$dis; 
					echo $inp->cb(two_dec($tp));?>
			</td>			
		</tr>
...
?>
		<tr>
			...
			<td><?php  $sp = ($arr[$i][4])-(($arr[$i][4])/100)*$dis;  echo $inp->cb(two_dec($sp));  ?></td>
			<td style = 'text-align:right'><?php  $tp = ($arr[$i][3]*$arr[$i][4])-(($arr[$i][3]*$arr[$i][4])/100)*$dis;  echo $inp->cb(two_dec($tp));  ?></td>
