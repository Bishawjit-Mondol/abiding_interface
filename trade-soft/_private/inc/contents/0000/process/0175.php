...
?>
	...
	<?php	$sales=0; $sales_rt=0; $receive=0; $total=$bl; 
		...
		<?  } ?>
					  ...
					  <tr> 
						<td colspan="8"><b>Summary of Sales Ledger </b></td>
					  </tr>
					  <tr> 
						<td colspan="3">Total Sales</td>
						<td  colspan="5" ><?php echo $inp->cb(two_dec($sales)); ?></td>
					  </tr>
					  <tr> 
						<td colspan="3">Received</b></td>
						<td  colspan="5" ><?php echo $inp->cb(two_dec($receive)); ?></td>
					  </tr>
					  <tr> 
						<td colspan="3">Total Sales Return</b></td>
						<td  colspan="5" ><?php echo $inp->cb(two_dec($sales_rt)); ?></td>
					  </tr>
					  <tr> 
						<td colspan="3">Closing Balance on <? echo dateconvert($d2); ?></td>
						<td  colspan="5" ><?php echo $inp->cb(two_dec($total)); ?></td>
					  </tr>					
