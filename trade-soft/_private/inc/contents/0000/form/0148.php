<?php
	...
	$label_4 =  ($lang == 1 ? "বিল তারিখ " : "Bill Date");

?>

                <form class="bs-example form-horizontal">
                    <fieldset>
<legend><?php echo ($lang? "নতুন  ":"New ");  echo req('cat_name'); echo ($lang? " বিল":" Bill "); ?> </legend>
						<div class="form-group">
							<div class = 'col-lg-3'>
								<div class="input-group margin-bottom-sm">
				                       		<span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i> 
				                       		<?php echo $label_4;?> </span><input type="text"  name="bl_date"  class="form-control date" />       
		          		           		</div>									
							</div>
							<div class = 'col-lg-3'>
								<div class="input-group margin-bottom-sm">
